...
function Home() {
  ...
  // const sortedFeatures = category.sort((a, b) => b.rating - a.rating);
  // setfeature(sortedFeatures);

  const key = "category";
  const key2 = "thumbnail";

  const newData = [...new Map(category.map((item) => [item[key], item[key2]]))];
  // console.log(newData);
  ...
  useEffect(() => {
    fetch("https://dummyjson.com/products?limit=22")
      ...
      .then((d) => {
        ...
        setcategory(d.products)
        setcategory(d.products);
        const sortedFeatures = d.products.filter((a) =>  a.rating>=4
         );
        setfeature(sortedFeatures);;
      });
  }, []);
              ...
              <div className="col-lg-3 col-md-4 col-sm-6 pb-1">
                ...
                >
                  <div className="cat-item d-flex align-items-center mb-4">
                    ...
                    >
                      <img className="img-fluid" src={cat[1]} alt="" />
                    </div>
            ...
            <div className="col-md-6">
              <div className="product-offer mb-30" style={{ height: 300 }}>
                ...
                <div className="offer-text">
                  <h6 className="text-white text-uppercase">Save 20%</h6>
                  <h3 className="text-white mb-3">Special Offer</h3>
                  <Link tp="/shop" className="btn btn-primary">
                    Shop Now
                  </Link>
                </div>
              </div>
