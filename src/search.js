...
function SearchBar() {
  ...
  useEffect(() => {
    fetch(`https://dummyjson.com/products/search?q=${location.state}`)
      .then((res) => res.json())
            ...
            <div className="row px-xl-5">
              ...
              <div className="col-lg-9 col-md-8">
                <div className="row pb-3">
                  ...
                  {/* {product.length == location.state && 
                    <h1>Not a relavent search</h1>
                  } */}
                  {product.length == 0 && <h1 className="text-info w-100 h-100 text-center">Not Found.....</h1>}
