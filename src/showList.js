...
function ShowList() {
  ...
  return (
    <>
      <h1>
        Here is my First product name: {list.title} and price: {list.price}. Get
        a 10% discount, bringing the price to{" "}
        {(list.price - list.price * 0.1).toFixed(2)}.
      </h1>
          ...
          <div className="row px-xl-5">
            ...
            <div className="col-lg-7 h-auto mb-30">
              <div className="h-100 bg-light p-30">
                ...
                <h3 className="font-weight-semi-bold mb-4">{list.price}</h3>
